...
<div id="header">
	<div class="pads clearfix">
		...
		<div style="text-align:right;"> <?php if(is_user_logged_in()) : include('login.php'); ?> </div>
		<div style="text-align:right;"> <?php include('logout.php'); ?>
		<?php else: include('register-link.php'); ?> </div>
		<div style="text-align:right;"> <?php include('login.php'); endif; ?></div>
		<div id="blocsearch" style="text-align:right;"> <?php include('searchform.php'); ?></div>
		<div class="nav-wrap">
			<div id="nav">
